...
productDistributionRouter.post('/', async (req: Request, res: Response) => {
    const createProductDistributionController = new CreateProductDistributionController(
    ...
    const productDistribution = await createProductDistributionController.createProductDistribution({
